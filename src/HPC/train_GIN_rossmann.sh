#!/bin/bash
#SBATCH --job-name="GIN"
#SBATCH --output=sling_logs/mean/rossmann/GIN-rossmann-%J.out
#SBATCH --error=sling_logs/mean/rossmann/GIN-rossmann-%J.err
...
srun python /d/hpc/projects/FRI/mj5835/PC7-DB_prediction/src/HPC/train.py --dataset rossmann --target_table historical --target Customers --task regression --model_name GIN 
