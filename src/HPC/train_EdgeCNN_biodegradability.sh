...
#SBATCH --output=sling_logs/mean/Biodegradability_v1/EdgeCNN-%J.out
#SBATCH --error=sling_logs/mean/Biodegradability_v1/EdgeCNN-%J.err
...
srun python /d/hpc/projects/FRI/mj5835/PC7-DB_prediction/src/HPC/train.py --dataset Biodegradability_v1 --target_table molecule --target activity --task regression --model_name EdgeCNN
