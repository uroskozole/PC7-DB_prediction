...
srun python /d/hpc/projects/FRI/mj5835/PC7-DB_prediction/src/HPC/train.py --dataset rossmann --target_table historical --target Customers --task regression --model_name GAT
