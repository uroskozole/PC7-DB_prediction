#!/bin/bash
#SBATCH --job-name="GIN"
#SBATCH --output=sling_logs/mean/Biodegradability_v1/GIN-Biodegradability_v1-%J.out
#SBATCH --error=sling_logs/mean/Biodegradability_v1/GIN-Biodegradability_v1-%J.err
